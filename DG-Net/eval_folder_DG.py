...
eval_parser.add_argument('--path', type=str, default="./weights_DG/train_DG_RL_N_re150_2/epoch_150.pth", help='You can change this path to our method weights mentioned here: https://huggingface.co/papers/2502.20272.')
eval_parser.add_argument('--input_folder', type=str, default="./Test/Test-NUID", help='The path of your image.')
...
eval_parser.add_argument('--output_folder', type=str, default="./results_DG/RL_N_re150_2/res-NUID", help='The path of your output.')
