...
eval_parser.add_argument('--path', type=str, default="./weights_DG/train_DG_WO-NR-780/epoch_150.pth", help='You can change this path to our method weights mentioned here: https://huggingface.co/papers/2502.20272.')
...
eval_parser.add_argument('--output_folder', type=str, default="./results_DG/WO-NR-780/res-LSUI-350", help='The path of your output.')
