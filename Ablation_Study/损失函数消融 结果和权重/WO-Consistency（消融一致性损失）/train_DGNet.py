...
def train(epoch):
    ...
    #     loss_c_L = loss_c_L + consisency_N_L.item()
        ...
        if iter == train_len:
            ...
            if not os.path.exists(opt.val_folder+'training_WO-Consistency'):          
                os.mkdir(opt.val_folder+'training_WO-Consistency') 
            output_img.save(opt.val_folder+'training_WO-Consistency/res.png')
            gt_img.save(opt.val_folder+'training_WO-Consistency/gt.png')
            ...
            output_rgb_NR_img.save(opt.val_folder+'training_WO-Consistency/res_NR.png')
...
if __name__ == '__main__':  
    ...
    with open(f"./{opt.val_folder}/training_WO-Consistency/metrics_record_WO-Consistency_{now}.md", "w") as f:
