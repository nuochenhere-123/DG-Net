...
eval_parser.add_argument('--path', type=str, default="./weights_DG/train_DG_WO-FR/epoch_150.pth", help='You can change this path to our method weights mentioned here: https://huggingface.co/papers/2502.20272.')
...
eval_parser.add_argument('--output_folder', type=str, default="./results_DG/WO-FR/res-LSUI-350", help='The path of your output.')
