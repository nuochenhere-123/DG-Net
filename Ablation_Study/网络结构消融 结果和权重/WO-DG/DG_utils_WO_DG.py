...
class encoderRGBLAB(nn.Module):
    ...
    # # DQ3
        ...
        up1ToRefine = self.convUpToRefine12(up1Refined)
    ...
    # # DQ2
        up2Refined = self.detailUp21(up2ToRefine)
        up2Refined = up2ToRefine + up2Refined
        up2ToRefine = self.convUpToRefine22(up2Refined)
    ...
    # # DQ1
        up3Refined = self.detailUp31(up3ToRefine)
        up3Refined = up3ToRefine + up3Refined
        up3ToRefine = self.convUpToRefine32(up3Refined)
