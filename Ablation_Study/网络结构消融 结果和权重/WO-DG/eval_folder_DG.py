...
eval_parser.add_argument('--path', type=str, default="./weights_DG/train_DG_WO-DG/epoch_150.pth", help='You can change this path to our method weights mentioned here: https://huggingface.co/papers/2502.20272.')
eval_parser.add_argument('--input_folder', type=str, default="./Test/Test-U45", help='The path of your image.')
...
eval_parser.add_argument('--output_folder', type=str, default="./results_DG/results_WO-DG/res-U45", help='The path of your output.')
