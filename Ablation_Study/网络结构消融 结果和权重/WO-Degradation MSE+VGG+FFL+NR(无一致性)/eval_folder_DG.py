...
eval_parser.add_argument('--path', type=str, default="./weights_DG/train_DG_WO-Degradation/epoch_150.pth", help='You can change this path to our method weights mentioned here: https://huggingface.co/papers/2502.20272.')
...
eval_parser.add_argument('--output_folder', type=str, default="./results_DG/results_WO-Degradation/res-LSUI-350", help='The path of your output.')
...
for image_name in image_files:
    ...
    with torch.no_grad():
        ...
        output_tensor, L = model(input_tensor.cuda(),input_tensor_wb.cuda(),input_tensor_gc.cuda(),input_tensor_his.cuda())
